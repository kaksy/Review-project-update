...
let reviews =[
    {
      ...
      text: 
      'I specialise in managing newly manifactured products. Bringing up different marketing strategy on ways to dominate the competitive market and ascertaining a greater value of the market share.'
    },
    {
      id: 2,
      name: 'Anna James',
      ...
      text:' i am into web designing, i design quality user friendly web pages with wonderful animations of distinguished functionality. I have 5 years of experience with notable good references from previouse clients who tends to be satisfied with my work '
    ...
    },
    {
      ...
      text:"I specialise in  writing programing langues :python, java, javascript, property sales agent and also into seling of gadgets. Brand director  Kv-star world"
    },
    {
      id: 5,
      name: 'Kingsman',
      job:'Engineer, crypto trader, Giftcard merchant, C.E.O KV-star World ',
      image:"./images/kingsman.jpg",
      text:' CEO Kv StarWorld, reliable giftcard merchant, studied Engineering in the University Of Uyo '
    },
    {
      id:6,
      name: 'Bar Utibe-Abasi Atan',
      job: 'Legal Practitioner',
      image:"./images/Cody guy.jpg",
      text:"I'm a legal practitioner into the following : Election Litigation, Taxation and Policies, Property law, Insurance Law, Corporate Practice" 
    },
    {
      id: 7,
      name:'Andrew',
      ...
      text: ' A certified doctor, studied medicine in the University of Uyo ',
    },
    {
      id: 8,
      name: 'Anie',
    ...
    },
    {
      ...
      text: 'A photograher with a specified years of experience, covers events, videography and a lot more owns Malvins photography'
    },
    {
      id: 10,
      name: "Smart'jay",
